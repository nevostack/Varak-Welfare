...
const Header = () => {
  ...
  const [isStartFundraiserModalOpen, setIsStartFundraiserModalOpen] =
    useState(false);
  const [isFundraiserCreationModalOpen, setIsFundraiserCreationModalOpen] =
    useState(false);
            ...
            <div className="md:hidden py-6 border-t-2 border-rose-100 animate-fade-in bg-gradient-to-b from-white to-rose-50/30 backdrop-blur-sm">
              <div className="flex flex-col space-y-1">
                ...
                <div className="space-y-1 mb-4">
                  <a
                    href="#"
                    className="text-gray-700 hover:text-rose-600 transition-all duration-300 font-semibold block p-4 hover:bg-gradient-to-r hover:from-rose-50 hover:to-pink-50 rounded-xl border border-transparent hover:border-rose-200 hover:shadow-md"
                  >
                    About Us
                  </a>
                  ...
                  <details className="group">
                    ...
                    <div className="mt-2 ml-4 space-y-2 pb-2">
                      <div className="mb-3">
                        ...
                        <a
                          href="#"
                          className="block text-sm text-gray-600 hover:text-rose-500 transition-colors p-2 hover:bg-rose-50 rounded-md"
                        >
                          Medical Treatment
                        </a>
                        <a
