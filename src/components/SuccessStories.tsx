...
const stories = [
  ...
  },
  {
    ...
    category: "Medical",
    urgency: "high",
    story: "45-year-old Rajesh was diagnosed with stage 3 lung cancer. With community support, he completed his treatment successfully.",
    fullStory: "Rajesh, a daily wage worker, was diagnosed with stage 3 lung cancer. The treatment cost was beyond his family's means. Through Varak, generous donors helped him receive chemotherapy, radiation therapy, and surgery. Today, Rajesh is cancer-free and back to supporting his family.",
  ...
  },
  {
    ...
    category: "Medical",
    urgency: "high",
    story: "38-year-old Mukesh was diagnosed with a brain tumor. Thanks to community support, he received life-saving surgery.",
    fullStory: "Mukesh, an engineer, started experiencing severe headaches and vision problems. Tests revealed a brain tumor that required immediate surgery. The expensive treatment was beyond his family's reach, but through Varak, donors helped fund his surgery and chemotherapy. Today, Mukesh is tumor-free and back to his normal life.",
  ...
  },
  {
    ...
    category: "Medical",
    urgency: "high",
    story: "52-year-old Sunita was diagnosed with breast cancer. Through community support, she received life-saving treatment.",
    fullStory: "Sunita, a school teacher, discovered a lump during a routine check-up. After diagnosis, the family was devastated by the treatment costs. Thanks to Varak donors, Sunita received surgery, chemotherapy, and reconstruction surgery. She's now cancer-free and back to teaching, inspiring her students with her courage.",
    impact: "Successfully completed breast cancer treatment and returned to normal life",
...
const SuccessStories = () => {
  ...
  const progressPercentage = ((currentStoryData.raised / currentStoryData.goal) * 100).toFixed(0);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <div className="inline-flex items-center gap-3 px-8 py-4 bg-white/90 backdrop-blur-sm border-2 border-rose-200 rounded-full shadow-2xl mb-8">
            ...
            <span className="text-rose-800 font-bold text-sm uppercase tracking-wide">Real Impact Stories</span>
            <div className="w-3 h-3 bg-rose-500 rounded-full animate-pulse"></div>
          </div>
          
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-4">
            <span className="text-gray-900">Stories of </span>
            <span className="bg-gradient-to-r from-rose-500 to-pink-600 bg-clip-text text-transparent">Hope</span>
            <span className="text-gray-900"> & </span>
            <span className="bg-gradient-to-r from-rose-500 to-pink-600 bg-clip-text text-transparent">Change</span>
          </h2>
          
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover how your contributions transform lives and create lasting impact in communities across India
          </p>
              ...
              >
                {isPlaying ? (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-gray-700">Auto-playing</span>
                  </div>
                ) : (
                  <div className="flex items-center gap-2">
            ...
            <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="relative overflow-hidden">
                  <div className="relative h-64 lg:h-96">
                    ...
                    <div className="relative w-full h-full">
                      <img 
                        src={showBeforeAfter ? currentStoryData.beforeImage : currentStoryData.image} 
                ...
                />
                    ...
                    <div className="absolute top-4 left-4 flex flex-col gap-2">
                      ...
                      >
                        <Badge className={`${getCategoryColor(currentStoryData.category)} border font-semibold shadow-lg backdrop-blur-sm`}>
                      ...
                      >
                        <Badge className={`${getUrgencyColor(currentStoryData.urgency)} border font-semibold shadow-lg backdrop-blur-sm`}>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                      <div className="text-white">
                        <div className="flex justify-between items-center mb-3">
                          ...
                          <span className="text-lg font-bold text-rose-400">{progressPercentage}%</span>
                        </div>
                        ...
                        <div className="flex justify-between items-center mt-2 text-xs text-gray-200">
                          <span>{formatCurrency(currentStoryData.raised)} raised</span>
                          <span>Goal: {formatCurrency(currentStoryData.goal)}</span>
                        </div>
                      </div>
                </div>
                    ...
                    <div className="absolute top-4 right-4">
                      ...
                      >
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span className="font-medium text-gray-700">{currentStoryData.location}</span>
                        </div>
                      </motion.div>
                </div>
                  ...
                  <div className="h-full flex flex-col">
                    ...
                    <div className="mb-6">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-2xl font-bold text-gray-900">{currentStoryData.name}</h3>
                          {currentStoryData.age && (
                            <p className="text-sm text-gray-500 font-medium">Age: {currentStoryData.age} years old</p>
                          )}
                          <div className="flex items-center gap-1 mt-1">
                            <MapPin className="h-3 w-3 text-gray-400" />
                            <span className="text-sm text-gray-600">{currentStoryData.location}</span>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-sm text-gray-500">Completed in</div>
                          <div className="text-lg font-bold text-rose-600">{currentStoryData.daysToComplete} days</div>
                        </div>
                      </div>
                      <h4 className="text-xl font-semibold text-gray-800 mb-3">{currentStoryData.title}</h4>
                    </div>
                    ...
                    <div className="mb-6 flex-grow">
                        ...
                        <div className="flex items-start gap-3 mb-4">
                          ...
                          <div>
                            <p className="text-gray-700 leading-relaxed italic text-lg">
                              "{showFullStory ? currentStoryData.fullStory : currentStoryData.story}"
                            </p>
                            <button
                      ...
                      <div className="bg-gradient-to-r from-rose-50 to-pink-50 rounded-xl p-5 border border-rose-100 shadow-sm">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <span className="font-bold text-rose-800 text-lg">Impact Achieved</span>
                        </div>
                        <p className="text-rose-700 font-medium text-base leading-relaxed">{currentStoryData.impact}</p>
            </div>
          </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      <div className="text-center bg-white rounded-xl p-4 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                        <div className="text-2xl font-bold text-rose-600 mb-1">{formatCurrency(currentStoryData.raised)}</div>
                        <div className="text-xs text-gray-600 font-medium uppercase tracking-wide">Amount Raised</div>
                      </div>
                      <div className="text-center bg-white rounded-xl p-4 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                        <div className="text-2xl font-bold text-rose-600 mb-1">{formatNumber(currentStoryData.donors)}</div>
                        <div className="text-xs text-gray-600 font-medium uppercase tracking-wide">Generous Donors</div>
                      </div>
                      <div className="text-center bg-white rounded-xl p-4 border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
                        <div className="text-2xl font-bold text-rose-600 mb-1">{currentStoryData.daysToComplete}</div>
                        <div className="text-xs text-gray-600 font-medium uppercase tracking-wide">Days to Success</div>
                      </div>
        </div>
                    ...
                    <div className="text-center bg-gray-50 rounded-xl p-4">
                      ...
                      <span className="text-sm text-gray-600 font-medium">Perfect Success Story</span>
                      <p className="text-xs text-gray-500 mt-1">Verified by Varak Team</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          >
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-rose-100 max-w-2xl mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                Join thousands of successful fundraisers who have transformed lives through Varak
              </p>
